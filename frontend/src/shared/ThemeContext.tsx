...
const RAW_THEMES: RawTheme[] = [
  ...
  },
  {
    ...
    name: 'Forest',
    tokens: {
      '--app-bg': '#052e16', '--surface-bg': '#064e27', '--card-bg': 'rgba(6, 78, 39, 0.55)', '--card-bg-solid': '#0a5f30',
      '--sidebar-bg': '#042a15', '--sidebar-hover': '#075c2e', '--sidebar-active': '#075c2e', '--navbar-bg': '#074825',
      '--border': '#166534', '--border-strong': '#22c55e',
      '--text-primary': '#dcfce7', '--text-secondary': '#86efac', '--text-tertiary': '#4ade80',
      '--accent-primary': '#4ade80', '--accent-primary-hover': '#86efac', '--accent-primary-bg': 'rgba(74, 222, 128, 0.16)', '--accent-primary-contrast': '#052e16',
      '--accent-secondary': '#a3e635', '--accent-secondary-bg': 'rgba(163, 230, 53, 0.16)',
      '--hover': 'rgba(74, 222, 128, 0.08)', '--input-bg': 'rgba(8, 74, 38, 0.90)',
      '--status-success': '#22c55e', '--status-success-bg': 'rgba(34, 197, 94, 0.20)',
      '--status-warning': '#fde047', '--status-warning-bg': 'rgba(253, 224, 71, 0.16)',
      '--status-error': '#fb7185', '--status-error-bg': 'rgba(251, 113, 133, 0.16)',
      '--status-info': '#6ee7b7', '--status-info-bg': 'rgba(110, 231, 183, 0.16)',
      '--chart-1': '#4ade80', '--chart-2': '#22c55e', '--chart-3': '#fde047', '--chart-4': '#f472b6', '--chart-5': '#38bdf8', '--chart-6': '#a78bfa',
      '--scroll-track': 'transparent', '--scroll-thumb': 'rgba(34, 197, 94, 0.40)', '--scroll-thumb-hover': 'rgba(74, 222, 128, 0.60)', '--scrollbar': 'rgba(34, 197, 94, 0.40)',
    },
  },
  {
    id: 'ocean',
  ...
  },
  {
    ...
    name: 'Soft Black',
    tokens: {
      '--app-bg': '#000000', '--surface-bg': '#050505', '--card-bg': 'rgba(15, 15, 15, 0.75)', '--card-bg-solid': '#0f0f0f',
      '--sidebar-bg': '#020202', '--sidebar-hover': '#121212', '--sidebar-active': '#121212', '--navbar-bg': '#050505',
      '--border': '#1a1a1a', '--border-strong': '#2e2e2e',
      '--text-primary': '#e5e5e5', '--text-secondary': '#999999', '--text-tertiary': '#666666',
      '--accent-primary': '#f5f5f5', '--accent-primary-hover': '#ffffff', '--accent-primary-bg': 'rgba(245, 245, 245, 0.08)', '--accent-primary-contrast': '#0a0a0a',
      '--accent-secondary': '#9ca3af', '--accent-secondary-bg': 'rgba(156, 163, 175, 0.08)',
      '--hover': 'rgba(255, 255, 255, 0.04)', '--input-bg': 'rgba(12, 12, 12, 0.95)',
      '--status-success': '#34d399', '--status-success-bg': 'rgba(52, 211, 153, 0.10)',
      '--status-warning': '#fbbf24', '--status-warning-bg': 'rgba(251, 191, 36, 0.10)',
      '--status-error': '#f87171', '--status-error-bg': 'rgba(248, 113, 113, 0.10)',
      '--status-info': '#60a5fa', '--status-info-bg': 'rgba(96, 165, 250, 0.10)',
      '--chart-1': '#ffffff', '--chart-2': '#34d399', '--chart-3': '#fbbf24', '--chart-4': '#f472b6', '--chart-5': '#60a5fa', '--chart-6': '#a78bfa',
      '--scroll-track': 'transparent', '--scroll-thumb': 'rgba(60, 60, 60, 0.50)', '--scroll-thumb-hover': 'rgba(95, 95, 95, 0.70)', '--scrollbar': 'rgba(60, 60, 60, 0.50)',
    },
  },
];
