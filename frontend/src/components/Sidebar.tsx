  ...
  return (
    <div id="app-sidebar" className="w-64 bg-zinc-950 border-r border-zinc-800 flex flex-col justify-between h-screen sticky top-0 shrink-0 text-zinc-100 font-sans">
      ...
      <div className="p-4 border-t border-zinc-900 bg-zinc-950">
        <div className="flex items-center space-x-3 mb-3 p-1.5">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 py-2 px-3 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-lg text-xs font-medium text-zinc-400 hover:text-white transition-all cursor-pointer"
        >
