...
export const Register: React.FC = () => {
  ...
  return (
    <div id="register-container" className="min-h-screen font-sans flex items-center justify-center relative p-6" style={{ backgroundColor: 'var(--app-bg)', color: 'var(--text-primary)' }}>
      {/* Background Orbs */}
